...
public class VisitNamePrintController {
	...
	public LabelPrintJobSummary printName(@RequestBody PrintVisitNameDetail detail) {
		RequestEvent<PrintVisitNameDetail> req = new RequestEvent<PrintVisitNameDetail>(detail);
		ResponseEvent<LabelPrintJobSummary> resp = visitSvc.printVisitNames(req);
